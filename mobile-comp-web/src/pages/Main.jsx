      ...
      <div style={{ marginLeft: '200px', padding: '20px' }}>
        ...
        <MaterialTable
          ...
          columns={[
            ...
            { title: 'Date', field: 'whatTime', type: 'datetime' }
          ]}
          ...
          editable={{
            ...
            onRowUpdate: async (newData, oldData) => {
              return axios.put(`http://localhost:5000/activities/${oldData.id}`, 
            ...
            onRowDelete: async (oldData) => {
              return axios.delete(`http://localhost:5000/activities/${oldData.id}`, {
                headers: {
                  Authorization: 'Bearer ' + cookies.token
                }
              }).then((response) => {
